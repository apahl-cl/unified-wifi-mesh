...
typedef enum {
    ...
    em_msg_type_topo_notif = 0x0001,
    em_msg_type_topo_query = 0x0002,
    em_msg_type_topo_resp = 0x0003,
    em_msg_type_topo_vendor = 0x0004,
    em_msg_type_link_metric_query = 0x0005,
    em_msg_type_link_metric_resp = 0x0006,
    em_msg_type_autoconf_search = 0x0007,
    em_msg_type_autoconf_resp = 0x0008,
    em_msg_type_autoconf_wsc = 0x0009,
    em_msg_type_autoconf_renew = 0x000a,
    em_msg_type_1905_ack = 0x8000,
    em_msg_type_ap_cap_query = 0x8001,
    em_msg_type_ap_cap_rprt = 0x8002,
    em_msg_type_map_policy_config_req = 0x8003,
    em_msg_type_channel_pref_query = 0x8004,
    em_msg_type_channel_pref_rprt = 0x8005,
    em_msg_type_channel_sel_req = 0x8006,
    em_msg_type_channel_sel_rsp = 0x8007,
    em_msg_type_op_channel_rprt = 0x8008,
    em_msg_type_client_cap_query = 0x8009,
    em_msg_type_client_cap_rprt = 0x800a,
    em_msg_type_ap_metrics_query = 0x800b,
    em_msg_type_ap_metrics_rsp = 0x800c,
    em_msg_type_assoc_sta_link_metrics_query = 0x800d,
    em_msg_type_assoc_sta_link_metrics_rsp = 0x800e,
    em_msg_type_unassoc_sta_link_metrics_query = 0x800f,
    em_msg_type_unassoc_sta_link_metrics_rsp = 0x8010,
    em_msg_type_beacon_metrics_query = 0x8011,
    em_msg_type_beacon_metrics_rsp = 0x8012,
    em_msg_type_combined_infra_metrics = 0x8013,
    em_msg_type_client_steering_req = 0x8014,
    em_msg_type_client_steering_btm_rprt = 0x8015,
    em_msg_type_client_assoc_ctrl_req = 0x8016,
    em_msg_type_steering_complete = 0x8017,
    em_msg_type_higher_layer_data = 0x8018,
    em_msg_type_bh_steering_req = 0x8019,
    em_msg_type_bh_steering_rsp = 0x801a,
    em_msg_type_channel_scan_req = 0x801b,
    em_msg_type_channel_scan_rprt = 0x801c,
    em_msg_type_dpp_cce_ind = 0x801d,
    em_msg_type_1905_rekey_req = 0x801e,
    em_msg_type_1905_decrypt_fail = 0x801f,
    em_msg_type_cac_req = 0x8020,
    em_msg_type_cac_term = 0x8021,
    em_msg_type_client_disassoc_stats = 0x8022,
    em_msg_type_svc_prio_req = 0x8023,
    em_msg_type_err_rsp = 0x8024,
    em_msg_type_assoc_status_notif = 0x8025,
    em_msg_type_tunneled = 0x8026,
    em_msg_type_bh_sta_cap_query = 0x8027,
    em_msg_type_bh_sta_cap_rprt = 0x8028,
    em_msg_type_proxied_encap_dpp = 0x8029,
    em_msg_type_direct_encap_dpp = 0x802a,
    em_msg_type_reconfig_trigger = 0x802b,
    em_msg_type_bss_config_req = 0x802c,
    em_msg_type_bss_config_rsp = 0x802d,
    em_msg_type_bss_config_res = 0x802e,
    em_msg_type_chirp_notif = 0x802f,
    em_msg_type_1905_encap_eapol = 0x8030,
    em_msg_type_dpp_bootstrap_uri_notif = 0x8031,
    em_msg_type_anticipated_channel_pref = 0x8032,
    em_msg_type_failed_conn = 0x8033,
    em_msg_type_agent_list = 0x8035,
    em_msg_type_anticipated_channel_usage_rprt = 0x8036,
    em_msg_type_qos_mgmt_notif = 0x8037,
} em_msg_type_t;
